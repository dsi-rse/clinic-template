...
See `dashboard/TUTORIAL.md` for a step-by-step walkthrough.  See
`dashboard/README.md` for the full command reference and one-time mentor setup
...
`dashboard/TUTORIAL.md` to get started.
{% endif %}
